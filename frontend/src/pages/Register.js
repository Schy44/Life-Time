...
import { Eye, EyeOff, Mail, Lock, User, AlertCircle, Sun, Moon } from 'lucide-react';
        ...
        <div className="min-h-screen flex w-full bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
            ...
            <div className="hidden lg:block lg:w-[60%] relative overflow-hidden">
                ...
                <div className="absolute bottom-20 left-20 text-white max-w-lg">
                    <h1 className="text-6xl font-black leading-tight mb-6">Find your partner.</h1>
                    <p className="text-xl text-gray-200 font-medium">Join thousands of others searching for a meaningful and lasting relationship.</p>
                </div>
            </div>
        ...
        <AnimatePresence>
            {error && (
                <motion.p
                    ...
                    exit={{ opacity: 0, y: -10 }}
                    className="text-xs font-semibold text-red-500 dark:text-red-400 ml-1 flex items-center gap-1"
                >
