                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-4 md:gap-0 mb-6">
                    ...
                    <div className="flex items-center gap-3">
                        {compatibility_score != null && !isPreview && (
                            <div className="text-sm font-semibold bg-gray-50 dark:bg-gray-700 border dark:border-gray-600 px-3 py-1 rounded-full dark:text-gray-200">{Math.round(compatibility_score * 100)}%</div>
                        )}
                                ...
                                <SectionCard title="Preferences" icon={<FaHeart className="text-red-500" />}>
                                    <div className="flex flex-wrap gap-2">
                                        {Object.entries(preferences[0]).slice(0, 12).map(([k, v]) => (
                                            <span key={k} className="px-3 py-1 bg-gray-100 dark:bg-gray-700 rounded-full text-sm text-gray-800 dark:text-gray-200">
